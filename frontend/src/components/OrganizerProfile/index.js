    ...
    render(){
        ...
        <div className={`${this.props.className } ${style.box} container row mt-5 pb-3`} style={{width: "85%"}}>
            ...
            <div className={`col align-self-center`}>
                <p className="secondaryTitleText importantTextColor mb-1">{this.state.organizerName}&nbsp;<Link to='/settings/organizeraccount'><i className="bi bi-pencil-fill" style={{fontSize: 'medium',verticalAlign: 'middle'}}></i></Link></p>
