  ...
  return (
      <main className="row justify-content-center mx-auto" style={{height:'90vh'}}>
        <div className="mt-5 pb-5" style={{width:'70vw'}}>
          ...
          <p className="bigText tonedTextOrange mb-3">Terms of Service</p>
          <div className="detailSubText">
            <p>Our Terms of Service were last updated on <strong>25th May 2022</strong>.</p>
            <p>Please read these terms and conditions carefully before using Our Service. (Just for reference, as this is a final year project, not an actual business website.)</p>
            <br/>
            ...
            <ul>
                ...
                <li>
                    <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to EventFinder.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>"Website"</strong> refers to EventFinder, accessible from localhost:3000.</p>
                </li>
                <li>
            ...
            <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email (copywrite@email.com) and include in Your notice a detailed description of the alleged infringement.</p>
            ...
            <p>You can contact our copyright agent via email (copywrite@email.com). Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</p>
            <br/>
            ...
            <ul>
                <li>By sending us an email: eventfinder@email.com</li>
            </ul>
            <p></p>
          </div>
        </div>
